...
HEADER
  print "<body link=\"yellow\" vlink=\"red\" bgcolor=\"black\" text=\"green\">\n";
...
HEADER
  ...
  print "<br><br>Le livre d'or [$guest_book_name] n'a pas été trouvé !!!<br> <font color=orange> Guest book  [$guest_book_name] was not found !!!</font><br><br><br>\n";
  print io::MyUtilities::ooter($doc, IMAGE_DIRECTORY_DEPOSIT . "powered.gif","0.2","Mozilla 1.7.12");
  exit;
