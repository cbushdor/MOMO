...
sub who_is {
    ...
    my @result_with_link = ();
    my $counter = 0;
    my @dressing = ("Hot","Sweet","Sauer","Spicy","Caramel");
	...
	$line = 
	    $extra_marge . "<tr>\n".
	    $extra_marge . "    <td><img src='image/bull6.gif'>\n" .
	    ...
	    $extra_marge . "                      <form action=\"JavaScript:window.open('admaddr.cgi?address=$l[5]');location.replace(\'$ENV{SCRIPT_NAME}\');\" method=post>\n".
...
#	    $extra_marge . "                          <input type=hidden name=address value=$l[5]>\n".
	    ...
	    $extra_marge . "                      <form action=\"JavaScript:window.open('open_whois.cgi?address=$l[5]');location.replace(\'$ENV{SCRIPT_NAME}\');\" method=post>\n".
...
#	    $extra_marge . "                          <input type=hidden name=address value=$l[5]>\n".
	    ...
	    (($l[0] !~ m/^0/) ? (
				 $extra_marge . "          <form action=\"JavaScript:window.open('open_log.cgi?id=$l[5]');location.replace(\'$ENV{SCRIPT_NAME}\');\" method=post>\n".
