...
It is old code. That's the begining of the project. It contains not the first code but the whole directory. So when untar you'll get all the old files that were used back in the days.
...
To unpack use the following instructions.

=over 12

=item To untar or decompress:

	tar xpvf SourceWWW.tar
